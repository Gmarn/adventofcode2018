...
def find_best_min_for_a_guard(guard_timeline)
  repetition = guard_timeline.length / 60
...
time_lines.each do |k, time_line|
  result = find_best_min_for_a_guard(time_line)
  print result
  puts k
end
